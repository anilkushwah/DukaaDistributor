...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.AddproductViewHolder> implements Filterable {
    Context context;
    private ArrayList<CategoryModel> categotyNameList = new ArrayList<>();

    private ArrayList<CategoryModel> mListData;
    Dialog dialog ;

    public CategoryAdapter(Context context, ArrayList<CategoryModel> mList, Dialog dialog1) {
    ...
    public void onBindViewHolder(@NonNull final AddproductViewHolder holder, final int position) {
        final CategoryModel mStateRespone = categotyNameList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // CreateOfferActivity.category_id = mStateRespone.getName();
                ...
                CreateOfferActivity.category_type = "category";
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (CategoryModel row : mListData) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                categotyNameList = (ArrayList<CategoryModel>) filterResults.values;
