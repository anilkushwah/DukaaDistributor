...
public class CutomerDetailsCancelActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initializationView() {
        ...
        if (bundle != null) {
            ...
            pastOrderListAdapter = new PastOrderListAdapter(CutomerDetailsCancelActivity.this, newCreditReq_model.getOrders());
    ...
    private void reqAccept(final String status) {
        final Dialog dialog = Utils.initProgressDialog(CutomerDetailsCancelActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.URL.update_credit_request, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                   ...
                   // Utils.T(CutomerDetailsCancelActivity.this, jsonObject.getString("message").toString());

                    if (jsonObject.getInt("status") == 200) {

                       finish();
                    }else {
                        Utils.T(CutomerDetailsCancelActivity.this, jsonObject.getString("message"));
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error.getClass().equals(TimeoutError.class)) {
                    ...
                    Utils.T(CutomerDetailsCancelActivity.this, errorMessage + " No Internet Connection available. Please try again");
                }
            }
        }) {
            @Override
        ...
        RequestQueue queue = Volley.newRequestQueue(CutomerDetailsCancelActivity.this);
