...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean status = NetworkUtil.getConnectivityStatus(MainActivity.this);
        if (status == true) {

        } else {
            Utils.T(MainActivity.this, "No Internet Connection available. Please try again");
        }
       ...
       /* com.dollop.retailer.adapter.ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(this,viewList);
